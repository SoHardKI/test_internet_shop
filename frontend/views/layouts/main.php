...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        $this->registerJsFile('/js/respond.min.js', ['position' => View::POS_HEAD, 'condition' => 'lte IE9']);
        ?>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="<?= \yii\helpers\Url::home() ?>"><?= Html::img('@web/images/home/logo.png') ?></a>
                            <div class="btn-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="<?= \yii\helpers\Url::to(['/admin']) ?>">Категории<i class="fa fa-angle-down"></i></a>
